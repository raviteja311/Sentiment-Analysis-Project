...
from src.utils import preprocess_tweet, compute_metrics, GRU_DIR
...
def main():
    ...
    joblib.dump(tokenizer, GRU_DIR / "tokenizer.joblib")
    ...
    checkpoint = ModelCheckpoint(str(GRU_DIR / "best.keras"), save_best_only=True, monitor="val_loss")
    ...
    model.save(str(GRU_DIR / "model_final.keras"))
